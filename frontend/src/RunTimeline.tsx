...
export function RunTimeline({runId,restartKey='',onChanged,initialOpen=true}:{runId:string;restartKey?:string;onChanged?:()=>void;initialOpen?:boolean}){
 ...
 },[runId,restartKey,open,reconnect]);
